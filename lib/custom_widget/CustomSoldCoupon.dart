...
class CustomSoldCoupon extends StatefulWidget {
  ...
  @override
  State<CustomSoldCoupon> createState() => _CustomSoldCoupon();
}

class _CustomSoldCoupon extends State<CustomSoldCoupon> {
  @override
    ...
    return Stack(
      children: [
            ...
            children: [
              Container(
                ...
                child: CachedNetworkImage(
                  imageUrl: "${widget.soldCoupon.simpleCoupon?.image}",
                  fit: BoxFit.cover,
              ...
              Padding(
                ...
                child: Align(
                  ...
                  child: Text(
                    "${widget.soldCoupon.simpleCoupon?.simpleProvider!.getPropertyEffectedByLang("name_${globals.SelectedLang}")}",
              ...
              SizedBox(
                ...
                child: Padding(
                  ...
                  child: Align(
                    ...
                    child: Text(
                      "${widget.soldCoupon.simpleCoupon?.getPropertyEffectedByLang("name_${globals.SelectedLang}")}",
                      maxLines: 2,
                      overflow: TextOverflow.ellipsis,
              ...
              Row(
                ...
                children: [
                  Text(
                    "${widget.soldCoupon.simpleCoupon?.priceBeforeDiscount} ",
                    style: TextStyle(
                        decoration: TextDecoration.lineThrough,
                        color: Colors.grey.shade400),
                  ),
                  Text(
                    "${widget.soldCoupon?.simpleCoupon?.price} " + S.of(context).S_R,
                    style: TextStyle(
        ...
        PositionedDirectional(
          ...
          child: CircleAvatar(
            backgroundImage:
                NetworkImage("${widget.soldCoupon.simpleCoupon?.simpleProvider!.logo}"),
          ),
        )
      ],
    );
