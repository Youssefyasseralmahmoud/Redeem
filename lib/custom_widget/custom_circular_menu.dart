...
class CustomCircularMenu extends StatefulWidget {
  ...
  final GlobalKey<CustomCircularMenuState>? key;

  /// list of CircularMenuItem contains at least two items.
  final List<CustomCircularMenuItem> items;
  ...
  @override
  CustomCircularMenuState createState() => CustomCircularMenuState();
}

class CustomCircularMenuState extends State<CustomCircularMenu>
